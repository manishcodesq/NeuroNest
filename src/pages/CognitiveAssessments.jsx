...
const CognitiveAssessments = () => {
  ...
  // Handle "Start Assessment" click for Focus Exercises
  const handleStartAssessment = (title) => {
    if (title === 'Focus Exercises') {
      setShowFocusTimer(true);
    } else {
      alert(`Starting ${title} functionality is not implemented yet.`);
    }
  };
              ...
              >
                ...
                >
                  <Stack direction="row" spacing={2} alignItems="center" mb={1}>
                    ...
                    <Box>
                      ...
                      <Stack direction="row" spacing={1} alignItems="center" mt={0.5}>
                        ...
                        <Typography sx={{ color: '#b0b0b0', fontSize: '0.95rem' }}>{a.time}</Typography>
                        <Chip
                          label={a.difficulty}
                          size="small"
                          sx={{
                  ...
                  <Button
                    ...
                    onClick={() => handleStartAssessment(a.title)}
                  >
                    Start Assessment
                  </Button>
                </Paper>
