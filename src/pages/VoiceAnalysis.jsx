          ...
          <Paper elevation={0} sx={{
            ...
            <Stack direction="row" alignItems="center" spacing={1} sx={{ alignSelf: 'flex-start', mb: 2 }}>
              ...
              <Typography sx={{ fontWeight: 700, fontFamily: 'Poppins', color: '#222', fontSize: '1.1rem' }}>
                {t('voiceAnalysis.voiceRecording')}
              </Typography>
            </Stack>
            ...
            <Button variant="contained" startIcon={<MicIcon />} sx={{
              ...
              {t('voiceAnalysis.startRecording')}
            </Button>
          </Paper>
        </Grid>
        <Grid item xs={12} md={5} sx={{ display: 'flex', justifyContent: 'center' }}>
          <Paper elevation={0} sx={{
            ...
            <Typography sx={{ fontWeight: 700, fontFamily: 'Poppins', color: '#222', fontSize: '1.1rem', mb: 2 }}>
              {t('voiceAnalysis.recordingTips')}
            </Typography>
            {tips.map((tip, idx) => (
              <Stack key={idx} direction="row" spacing={2} alignItems="flex-start" mb={2}>
